...
# API Endpoints
list_chatbots_url = "https://marzi-chatbase.cyces.co/api/chatbase/list-chatbot/"
new_thread_url = "https://marzi-chatbase.cyces.co/api/chatbase/new-thread/"
...
if 'thread_id' in st.session_state and st.session_state.thread_id:
    ...
    if user_question:
        ...
        response = requests.post("https://marzi-chatbase.cyces.co/api/chatbase/chat/", json=payload)
